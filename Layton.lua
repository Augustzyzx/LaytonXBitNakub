...
_G.Color = Color3.fromRGB(63, 232, 21)
...
if IKAI then
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://11614381123"
		-- http://www.roblox.com/asset/?id=11614381123
	...
	ImageLabelfps.Image = "rbxassetid://11614381123"
	...
	ImageLabeltime.Image = "rbxassetid://11614381123"
	...
	Yedhee.TextTransparency = 1
		...
		function uitab:Tab(text,logo1)
			...
			function main:Dropdown(text,old,option,callback)
				...
				DropImage.Image = "rbxassetid://11614381123"
...
game.StarterGui:SetCore("SendNotification", {
	...
	Icon = "http://www.roblox.com/asset/?id=11614381123",
	Duration = 8
})
...
ImageButton.Image = "http://www.roblox.com/asset/?id=11614381123"
ImageButton.MouseButton1Down:connect(function()
    game:GetService("VirtualInputManager"):SendKeyEvent(true,305,false,game)
    game:GetService("VirtualInputManager"):SendKeyEvent(false,305,false,game)
end)

local win = library:Window("Layton",[[Hub]],[[Version : Premium ]],"11614381123",Enum.KeyCode.RightControl)
...
PvP_Tab:Toggle("infinite Ability","9606294253",false,function(vu)
   InfinitsAbility = vu
	if vu then
		infinitestam()
	end
	_G.Setting_table.InfinitsAbility = vu
	Update_Setting(getgenv()['MyName'])
end)
	local LocalPlayer = game:GetService'Players'.LocalPlayer
	local originalstam = LocalPlayer.Character.Ability.Value
	function infinitestam()
		game:GetService'Players'.LocalPlayer.Character.Energy.Changed:connect(function()
			if InfinitsAbility then
				LocalPlayer.Character.Ability.Value = originalstam
			end 
		end)
	end
