		...
		function CheckLevel2()
			...
			if Three_World and not Auto_Raid then
				...
				elseif Lv >= 2225 and Lv <= 2249 or SelectMonster == "Cake Guard [Lv. 2225]" then 
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2250 or Lv <= 2300 or SelectMonster == "Baking Staff [Lv. 2250]" then 
					Ms = "Baking Staff [Lv. 2250]"
					NameQuest = "CakeQuest2"
					QuestLv = 1
					NameMon = "Baking Staff"
...
if IKAI then
	...
	local Properties = {
		RoundFrame = {
			...
			Image = "http://www.roblox.com/asset/?id=11667490949",
	...
	function library:Window(text,text2,text3,logo,keybind)
		...
		ToggleImgUi.Image = "rbxassetid://11667490949"
		-- http://www.roblox.com/asset/?id=11667490949
	...
	ImageLabelfps.Image = "rbxassetid://11667490949"
	...
	ImageLabeltime.Image = "rbxassetid://11667490949"
	...
	Yedhee.TextTransparency = 1
		...
		function uitab:Tab(text,logo1)
			...
			function main:Dropdown(text,old,option,callback)
				...
				DropImage.Image = "rbxassetid://11667490949"
...
game.StarterGui:SetCore("SendNotification", {
	Title = "Layton Notification", 
	Text = "ฟังชั่นที่มีไอคอนนี้สามารถเปิด\nพร้อมฟามเวลได้",
	Icon = "http://www.roblox.com/asset/?id=11667490949",
	Duration = 8
})

local win = library:Window("Layton",[[Hub]],[[Version : FreeMobie ]],"11667490949",Enum.KeyCode.RightControl)
...
General_Tab:Label('Farm godhuman')
General:Toggle("Auto Farm Fish Tail [World 1-3]","9606294253",_G.AutoFarmFishTail1,function(value)
...
General:Toggle("Auto Farm Fish Tail [World 1-3]","9606294253",_G.AutoFarmFishTail2,function(value)
...
General:Toggle("Auto Farm Magma Ore[World 1-2]","9606294253",_G.AutoFarmMagmaOre,function(value)
...
General:Toggle("Auto Farm Magma Ore[World 1-2]","9606294253",_G.AutoFarmMagmaOre2,function(value)
...
General:Toggle("Auto Farm Mystic Droplet ","9606294253",_G.AutoFarmMysticDroplet,function(value)
...
General:Toggle("Auto Farm Mystic Droplet ","9606294253",_G.AutoFarmDragonScales,function(value)
...
Quest_Tab:Toggle("Auto Dough","9606294253",_G.Setting_table.Auto_Spikey_Trident,function(vu)
...
General_Tab:Toggle("Auto Dough","9606294253",_G.Setting_table.Auto_Spikey_Trident,function(vu)
	Auto_Spikey_Trident = vu
	_G.Setting_table.Auto_Spikey_Trident = vu
	Update_Setting(getgenv()['MyName'])
end)
...
PvP_Tab:Label("Bounty")
	...
	PvP_Tab:Toggle("Aimbot Skill Nearest","9606294253",false,function(vu)
		Skillaimbot = vu
		if Skillaimbot then
