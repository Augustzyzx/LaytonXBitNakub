...
General_Tab:Label('Farm godhuman')
 ...
 if W then
General:Toggle("Auto Farm Fish Tail [World 1-3]","6022668898",_G.AutoFarmFishTail1,function(value)
...
if W3 then
General:Toggle("Auto Farm Fish Tail [World 1-3]","6022668898",_G.AutoFarmFishTail2,function(value)
...
if W then
General:Toggle("Auto Farm Magma Ore[World 1-2]","6022668898",_G.AutoFarmMagmaOre,function(value)
