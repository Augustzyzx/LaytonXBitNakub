...
function SomeLib:Window(text,mainclr,cls)
	local PresetColor = mainclr or Color3.fromRGB(250, 211,13) or _G.Color
...
local serv = win:Server("Uranium Hub","")
...
local Main = serv:Channel("General", "http://www.roblox.com/asset/?id=7040391851")
local Ss = serv:Channel("Stats","http://www.roblox.com/asset/?id=7040410130")
local P = serv:Channel("PvP","http://www.roblox.com/asset/?id=7251993295")
...
local A = serv:Channel("setting general","http://www.roblox.com/asset/?id=")
...
spawn(function()
    ...
    A:Toggle("Very Fast Attack 1",false,function(value)
