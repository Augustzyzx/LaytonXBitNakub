...
local foldername = "URANIUM HUB V2"
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Augustzyzx/LaytonXBitNakub/main/colorripper.lua"))()
local Wait = library.subs.Wait

local PepsisWorld = library:CreateWindow({
    Name = "URANIUM HUB V2",
    Themeable = {
    Info = "Discord Server: mNfajtTG4u"
    }
})
...
SettingSection:AddDropdown({
    ...
    List = {"Bring Mob [Normal]","Bring Mob [Fast]"},
    Callback = function(value)
